...
CREATE TABLE IF NOT EXISTS `cart` (
  ...
  `customer_cookie` int DEFAULT NULL,
...
-- Dumping structure for table app.products
DROP TABLE IF EXISTS `products`;
CREATE TABLE IF NOT EXISTS `products` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb4_polish_ci NOT NULL,
  `category_id` int DEFAULT '0',
  `desc` int NOT NULL DEFAULT (0),
  `pricegr` int NOT NULL DEFAULT (0),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_polish_ci;
